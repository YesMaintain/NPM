 ...
 */
exports.default = (function (Search) { return __awaiter(void 0, void 0, void 0, function () {
    var Results;
    return __generator(this, function (_a) {
        Results = new Map();
        Search.forEach(function (Search) { return __awaiter(void 0, void 0, void 0, function () {
            var Directory;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require("./WalkUntilGit.js"); })];
                    case 1: return [4 /*yield*/, (_a.sent()).default(Search)];
                    case 2:
                        Directory = _a.sent();
                        Results.set(Directory, Results.has(Directory)
